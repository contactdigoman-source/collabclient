...
import { StyleSheet, TextInput, View, ViewStyle, TextStyle, ImageSourcePropType } from 'react-native';
...
interface AppInputProps extends TextInputProps {
  ...
  error?: string | null;
  refName?: React.RefObject<TextInput | null>;
  rightContent?: ReactNode;
  icon?: ImageSourcePropType;
  isBorderFocused?: boolean;
...
function AppInput({
  ...
  const inputRef = refName || useRef<TextInput>(null);
