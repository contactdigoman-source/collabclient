...
const MyTeamListItem = ({ teamName = '', isDummy=false }) => {
  ...
  const containerStyle = useMemo(
    () => [
      styles.container,
      {
        backgroundColor: isDummy?colors.my_teams_dummy_item_bg: colors.my_teams_item_bg,
        borderColor: isDummy?colors.transparent: colors.my_teams_item_border,
      },
    ],
    [colors.my_teams_item_bg, colors.my_teams_item_border, isDummy],
  );
