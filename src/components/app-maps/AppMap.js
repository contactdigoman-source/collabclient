...
import { DEFAULT_REGION, hp, Icons, wp } from '../../constants';
...
const AppMap = ({
  ...
  const handleRefreshPress = useCallback(onRefreshPress, [onRefreshPress]);
  ...
  return (
    <View style={style}>
      <MapView
        ...
        {...rest}
      >
        {region && <Marker key="marker" coordinate={region} />}
        {children}
      </MapView>
